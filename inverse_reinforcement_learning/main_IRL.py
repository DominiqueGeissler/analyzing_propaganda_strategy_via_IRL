...
df_RT_a=pd.read_csv("df_rt_a_users.csv") # retweets generated by trolls (resp. users)
df_rp_a=pd.read_csv("df_rp_a_users.csv") # replies generated by trolls (resp. users)
df_tw_a=pd.read_csv("df_tw_a_users.csv") # original tweets generated by trolls (resp. users)
df_m_a=pd.read_csv("df_m_a_users.csv") # tweets with mentions generated by trolls (resp. users)

### passively involved tweets
df_RT_m=pd.read_csv("df_rt_m_users.csv")  # retweets of trolls' (resp. users) generated content
df_rp_m=pd.read_csv("df_rp_m_users.csv") # replies to trolls' (resp. users) generated content
df_m_m=pd.read_csv("df_m_m_users.csv") # tweets where trolls (resp. users) were mentioned
...
df_results.to_csv("df_results_users_IRL.csv",index=False) # save rewards in a csv file (NB:change the name of the file for generic users in df_results_users_IRL.csv)
